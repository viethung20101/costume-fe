...
namespace FrostweepGames.Plugins.GoogleCloud.SpeechRecognition
{
    ...
    public class WelcomeDialog : EditorWindow
    {
		...
		private void OnGUI()
        {
            ...
            {
                Application.OpenURL("https://www.youtube.com/@FrostweepGames");
            }
            ...
            EditorGUILayout.Space();
            GeneralConfig.Config.apiVersion = (GeneralConfig.APIVersion)EditorGUILayout.EnumPopup("API Version", GeneralConfig.Config.apiVersion);
        }
    }
}